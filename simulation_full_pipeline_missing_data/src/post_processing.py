...
from plotting import plot_all_heatmaps
import os
...
def post_processing_wrapper(data_folder, plot_folder, avg_data_folder, final_results_folder, house_polygons, verbose=False):
    ...
    Args:
        ...
        house_polygons (str): Path to the house polygons file.
    ...
    plot_all_heatmaps(data_folder=f"{data_folder}/final_results", plot_folder=plot_folder, house_polygons=house_polygons, verbose=verbose)

    plot_all_heatmaps(data_folder=data_folder, plot_folder=plot_folder, house_polygons=house_polygons, verbose=verbose)
